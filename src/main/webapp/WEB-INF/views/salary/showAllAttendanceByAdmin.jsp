...
.shortcut-box a:hover{
	...
	<body id="top">
		...
		<div id="nav">
			<ul>
				<li><a href="getPersonChecking-inByAdmin.do">个人考勤</a></li>
				<li><a href="showAllAttendance.do?flag=admin" class="current">&nbsp;&nbsp;&nbsp;&nbsp;统计&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
			</ul>
		</div>
		<!--搜索部分 start-->
		<div id="toolbar">
				...
				<tr class="t_title" style="background-color: #A3C6FB">
					...
					<c:forEach var="statistic" items="${list}" varStatus="status">
						<tr class="collect_item">
								...
								<td>
									<a title="查看明细" href="getPersonChecking-inByAdmin.do?every_month=${every_month }&user_name=${statistic.user_name }">${statistic.user_name }</a>
								</td>
		...
		<div id="menu" class="menu">
				<h3>部门分类</h3>
				<ul>
				<li><a class="cwb" href="showAllAttendance.do?department=财务部&start_month=${start_month }&end_month=${end_month }&flag=admin">财务部</a></li>
				<li><a class="jsb" href="showAllAttendance.do?department=技术部&start_month=${start_month }&end_month=${end_month }&flag=admin">技术部</a></li>
				<li><a class="kfb" href="showAllAttendance.do?department=客服部&start_month=${start_month }&end_month=${end_month }&flag=admin">客服部</a></li>
				<li><a class="rzb" href="showAllAttendance.do?department=人资部&start_month=${start_month }&end_month=${end_month }&flag=admin">人资部</a></li>
				<li><a class="swb" href="showAllAttendance.do?department=商务拓展部&start_month=${start_month }&end_month=${end_month }&flag=admin">商务拓展部</a></li>
				<li><a class="scyb" href="showAllAttendance.do?department=市场1部&start_month=${start_month }&end_month=${end_month }&flag=admin">市场1部</a></li>
				<li><a class="sceb" href="showAllAttendance.do?department=市场2部&start_month=${start_month }&end_month=${end_month }&flag=admin">市场2部</a></li>
				<li><a class="scsb" href="showAllAttendance.do?department=市场3部&start_month=${start_month }&end_month=${end_month }&flag=admin">市场3部</a></li>
				<li><a class="cpyyb" href="showAllAttendance.do?department=产品运营部&start_month=${start_month }&end_month=${end_month }&flag=admin">产品运营部</a></li>
				<li><a class="wwb" href="showAllAttendance.do?department=无为部&start_month=${start_month }&end_month=${end_month }&flag=admin">无为部</a></li>
				<li><a class="zjb" href="showAllAttendance.do?department=总经办&start_month=${start_month }&end_month=${end_month }&flag=admin">总经办</a></li>
				</ul>
		</div>
